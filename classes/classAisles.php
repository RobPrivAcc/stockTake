...
class aislesOptions
{
    ...
    private $donaghmedeArray = array('1','2A','2B','2C','2D','2E','2F','2 TOP','3A','3B','3C','4','4 TOP','5A','5B','6A','6B','6C','7A','7B','7C','7D','8A','8B','8C','8D','8 TOP','9A','9B','9C','9D','9 TOP','10A','10B','10C','10D','10 TOP','YOGGIES','FRIDGE');
    private $charlestownArray = array('1A','1B','1C','1D','1E','1F','1G','1H','1I','1J','1K','1L','2','3A','3B','3C','3D','3E','3F','3G','3H','4A','4B','4C','4D','5A','5B','5C','5D','6A','6B','6C','6D','7A','7B','7C','7D','8A','8B','8C','8D','9A','9B','9C','9D','10A','10B','10C','10D','FLOOR','TAGS','YOGIES','FRIDGE','WINDOW','FISH','SMALL ANIMAL');
    ...
    public function getAisles($store,$id) {
        ...
        //$option = '<Div class="form-group">';
            $option = '<select id="'.$id.'" class="selectpicker form-control">';
            
                if($store == 'Swords'){
                    $this->currentStoreArray = $this->swordsArray;
                }
		
				if($store == 'Charlestown'){
                    $this->currentStoreArray = $this->charlestownArray;
                }
        ...
        return $option;
       //print_r($this->currentStoreArray);
    }
}
?>
